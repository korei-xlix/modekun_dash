...
# オリジナルとの違い <a name="aDifference"></a>
基本的にオリジナルとの差分はありませんが、取り扱う閾値が異なります。  
  
* 単語繰り返し閾値を無効にできる（０に設定）。  
* 文字数上限が 1024 まで設定できる。  
